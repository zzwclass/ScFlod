...
class ProDesign_Model(nn.Module):
    ...
    def forward(self, h_V, h_P, P_idx, batch_id, S, mask,AT_test=False, mask_bw=None, mask_fw=None, decoding_order=None,
                return_logit=False):
        t1 = time.time()
        ...
        log_probs, logits = self.decoder(h_V,batch_id=None)
